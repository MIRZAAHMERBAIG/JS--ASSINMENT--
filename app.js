...
// document.write(visitorsName + " ordered " + quantity + " T-Shirts on " +  productTitle);
...
// document.write("Variables names can only contain " + " " + num  + sign + " and _. for Example :" + variable );
